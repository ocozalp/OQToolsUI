...
public class GemFileParser {
    ...
    private static final Namespace QML_NAMESPACE =
            new Namespace("qml", "http://quakeml.org/xmlns/quakeml/1.1");

    private static final Namespace NRML_NAMESPACE =
            new Namespace("", "http://openquake.org/xmlns/nrml/0.2");

    // Properties are in the form NAMESPACE_PROPERTYNAME
    // GML Properties
    private static final QName GML_LINE_STRING =
            new QName("LineString", GML_NAMESPACE);

    private static final QName GML_NAME = new QName("name", GML_NAMESPACE);

    private static final QName GML_POS_LIST =
            new QName("posList", GML_NAMESPACE);

    private static final QName GML_ID = new QName("id", GML_NAMESPACE);
    private static final QName GML_POINT = new QName("Point", GML_NAMESPACE);
    private static final QName GML_POS = new QName("pos", GML_NAMESPACE);

    private static final QName GML_EXTERIOR =
            new QName("exterior", GML_NAMESPACE);

    private static final QName GML_POLYGON = new QName("Polygon", GML_NAMESPACE);

    private static final QName GML_LINEAR_RING =
            new QName("LinearRing", GML_NAMESPACE);

    // NRML Properties
    private static final QName NRML_SOURCE_MODEL =
            new QName("sourceModel", NRML_NAMESPACE);

    private static final QName NRML_SIMPLE_FAULT_SOURCE =
            new QName("simpleFaultSource", NRML_NAMESPACE);

    private static final QName NRML_POINT_SOURCE =
            new QName("pointSource", NRML_NAMESPACE);

    private static final QName NRML_TECTONIC_REGION =
            new QName("tectonicRegion", NRML_NAMESPACE);

    private static final QName NRML_EDI_MFD =
            new QName("evenlyDiscretizedIncrementalMFD", NRML_NAMESPACE);

    private static final QName NRML_BIN_SIZE =
            new QName("binSize", NRML_NAMESPACE);

    private static final QName NRML_SIMPLE_FAULT_GEOMETRY =
            new QName("simpleFaultGeometry", NRML_NAMESPACE);

    private static final QName NRML_FAULT_TRACE =
            new QName("faultTrace", NRML_NAMESPACE);

    private static final QName NRML_UPPER_SEISM_DEP =
            new QName("upperSeismogenicDepth", NRML_NAMESPACE);

    private static final QName NRML_LOWER_SEISM_DEP =
            new QName("lowerSeismogenicDepth", NRML_NAMESPACE);

    private static final QName NRML_CONFIG = new QName("config", NRML_NAMESPACE);
    private static final QName NRML = new QName("nrml", NRML_NAMESPACE);
    private static final QName NRML_RAKE = new QName("rake", NRML_NAMESPACE);

    private static final QName NRML_MIN_VAL =
            new QName("minVal", NRML_NAMESPACE);

    private static final QName NRML_DIP = new QName("dip", NRML_NAMESPACE);

    private static final QName NRML_COMPLEX_FAULT_SOURCE =
            new QName("complexFaultSource", NRML_NAMESPACE);

    private static final QName NRML_COMPLEX_FAULT_GEOMETRY =
            new QName("complexFaultGeometry", NRML_NAMESPACE);

    private static final QName NRML_FAULT_EDGES =
            new QName("faultEdges", NRML_NAMESPACE);

    private static final QName NRML_FAULT_TOP_EDGE =
            new QName("faultTopEdge", NRML_NAMESPACE);

    private static final QName NRML_FAULT_BOTTOM_EDGE =
            new QName("faultBottomEdge", NRML_NAMESPACE);

    private static final QName NRML_AREA_SOURCE =
            new QName("areaSource", NRML_NAMESPACE);

    private static final QName NRML_AREA_BOUNDARY =
            new QName("areaBoundary", NRML_NAMESPACE);

    private static final QName NRML_RUPTURE_RATE_MODEL =
            new QName("ruptureRateModel", NRML_NAMESPACE);

    private static final QName NRML_FOCAL_MECHANISM =
            new QName("focalMechanism", NRML_NAMESPACE);

    private static final QName NRML_RUPTURE_DEPTH_DISTRIBUTION =
            new QName("ruptureDepthDistribution", NRML_NAMESPACE);

    private static final QName MAGNITUDE =
            new QName("magnitude", NRML_NAMESPACE);

    private static final QName DEPTH = new QName("depth", NRML_NAMESPACE);

    private static final QName NRML_HYPOCENTRAL_DEPTH =
            new QName("hypocentralDepth", NRML_NAMESPACE);

    private static final QName NRML_LOCATION =
            new QName("location", NRML_NAMESPACE);

    private static final QName NRML_GUTENBERG_MFD =
            new QName("truncatedGutenbergRichter", NRML_NAMESPACE);

    private static final QName NRML_A_VALUE =
            new QName("aValueCumulative", NRML_NAMESPACE);

    private static final QName NRML_B_VALUE =
            new QName("bValue", NRML_NAMESPACE);

    private static final QName NRML_MIN_MAGNITUDE =
            new QName("minMagnitude", NRML_NAMESPACE);

    private static final QName NRML_MAX_MAGNITUDE =
            new QName("maxMagnitude", NRML_NAMESPACE);

    private static final QName NRML_PUBLIC_ID =
            new QName("publicID", NRML_NAMESPACE);

    // QML Properties
    private static final QName QML_NODAL_PLANES =
            new QName("nodalPlanes", QML_NAMESPACE);

    private static final QName QML_NODAL_PLANE1 =
            new QName("nodalPlane1", QML_NAMESPACE);

    private static final QName QML_STRIKE = new QName("strike", QML_NAMESPACE);
    private static final QName QML_VALUE = new QName("value", QML_NAMESPACE);
    private static final QName QML_DIP = new QName("dip", QML_NAMESPACE);
    private static final QName QML_RAKE = new QName("rake", QML_NAMESPACE);
    ...
    public void writeSource2NrmlFormat(File file) {
        ...
        Element root = doc.addElement(NRML);

        root.add(GML_NAMESPACE);
        root.add(QML_NAMESPACE);
        root.addAttribute(GML_ID, "n1");

        Element sourceModel = root.addElement(NRML_SOURCE_MODEL);
        sourceModel.addAttribute(GML_ID, "sm1");
        sourceModel.addElement(NRML_CONFIG);
        ...
        for (GEMSourceData src : srcDataList) {
            if (src instanceof GEMFaultSourceData) {
                ...
                QName simpleFaultQName = NRML_SIMPLE_FAULT_SOURCE;
                ...
                addLocationsTo(source.getRegion().getBorder(), sourceElement
                        .addElement(NRML_AREA_BOUNDARY)
                        .addElement(GML_POLYGON).addElement(GML_EXTERIOR));
                ...
                QName areaSourceQName = NRML_POINT_SOURCE;
                Element sourceElement = sourceModel.addElement(areaSourceQName);
                ...
                // <location>
                Element pos =
                        sourceElement.addElement(NRML_LOCATION)
                                .addElement(GML_POINT)
                                .addElement(GML_POS);
    ...
    private void addHypocentralDepthTo(Double depth, Element element) {
        Element hypocentralDepth =
                element.addElement(NRML_HYPOCENTRAL_DEPTH);
    ...
    private void addDepthDistributionTo(ArbitrarilyDiscretizedFunc dist,
        ...
        Element ruptureDistribution =
                element
                        .addElement(NRML_RUPTURE_DEPTH_DISTRIBUTION);

        Element magnitude =
                ruptureDistribution.addElement(MAGNITUDE);

        magnitude.addText(valuesAsString(dist.getXVals()));

        Element depth = ruptureDistribution.addElement(DEPTH);
    ...
    private void addRuptureModelTo(MagFreqDistsForFocalMechs mechs,
    	...
    	if(mechs.getNumFocalMechs() == 0) {
    		int a = 0;
    	}
        for (int i = 0; i < mechs.getNumFocalMechs(); i++) {
            Element rateModel =
                    element.addElement(NRML_RUPTURE_RATE_MODEL);

            appendMFDTo(mechs.getMagFreqDist(i), rateModel);

            FocalMechanism mech = mechs.getFocalMech(i);

            Element focalMech = rateModel.addElement(NRML_FOCAL_MECHANISM);

            focalMech.addAttribute(NRML_PUBLIC_ID, "smi:f01/1" + i);

            Element plane1 =
                    focalMech.addElement(QML_NODAL_PLANES).addElement(QML_NODAL_PLANE1);

            Element strike = plane1.addElement(QML_STRIKE);

            Element value = strike.addElement(QML_VALUE);
            value.addText(Double.toString(mech.getStrike()));

            Element dip = plane1.addElement(QML_DIP);
            value = dip.addElement(QML_VALUE);
            value.addText(Double.toString(mech.getDip()));

            Element rake = plane1.addElement(QML_RAKE);
            value = rake.addElement(QML_VALUE);
            value.addText(Double.toString(mech.getRake()));
        }
    }

    private void addLocationsTo(LocationList locations, Element element) {
        Element lineString = element.addElement(GML_LINEAR_RING);
        Element posList = lineString.addElement(GML_POS_LIST);
    ...
    private void addLocationsTo(FaultTrace trace, Element element) {
        Element lineString = element.addElement(GML_LINE_STRING);
        Element posList = lineString.addElement(GML_POS_LIST);
    ...
    private void appendMFDTo(IncrementalMagFreqDist mfd, Element element) {
        if (mfd instanceof GutenbergRichterMagFreqDist) {
            ...
            Element gutRich =
                    element.addElement(NRML_GUTENBERG_MFD);

            gutRich.addElement(NRML_A_VALUE).addText(
                    Double.toString(aVal));

            gutRich.addElement(NRML_B_VALUE).addText(
                    Double.toString(bVal));

            gutRich.addElement(NRML_MIN_MAGNITUDE).addText(
                    Double.toString(minMagnitude));

            gutRich.addElement(NRML_MAX_MAGNITUDE).addText(
